...
export function useHackingSounds() {
  ...
  function playHackingHoverSound() {
    ...
    soundIndexHover.current = (soundIndexHover.current + 1) % hackingHoverSrc.length
  }
  ...
  function playHackingClickSound() {
    ...
    soundIndexClick.current = (soundIndexClick.current + 1) % hackingClickSrc.length
  }
  ...
  function playHackingScrollSound() {
    ...
    soundIndexScroll.current = (soundIndexScroll.current + 1) % hackingScrollSrc.length
  }
